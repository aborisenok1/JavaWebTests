...
public class AnonymRecoveryMobileScreen extends BasePage {

    private SelenideElement recoveryByPhoneButton = $(byCssSelector("[class='svg-ic svg-ico_phone_24 svg-ic48']"));

    private SelenideElement recoveryByEmailButton = $(byCssSelector("[class='svg-ic svg-ico_message_24 svg-ic48']")); //changed to mobile
    ...
    private SelenideElement getCodeButtonOnTheEmailPage = $(byCssSelector("[class='button-pro __wide']"));
